"""
Smart AI Telegram Bot - Enhanced Multi-Provider AI Engine v3 (FIXED)
...
class MultiProviderAI:
    ...
    async def _call_nvidia_rag(
        ...
        try:
            messages = [
                {"role": "system", "content": "You are GPT-5, an advanced AI model fine-tuned by @durov9369. You provide accurate, detailed, and helpful responses with context awareness."}
            ]
    ...
    async def detect_intent(self, message: str, has_photo: bool = False) -> Dict:
        ...
        if has_photo:
            ...
            # Explicit image generation (ignore photo, user wants to create new one)
                ...
                # Default: Vision analysis for photos
                return {
                    "type": "vision",
        ...
        # Default: General chat with RAG (use Nemotron Ultra)
        return {
            "type": "general",
            "model": AI_CHAIN["ultra"],
            "prompt": message,
    ...
    # ================== MAIN PROCESSING (ENHANCED & FIXED) ==================
    ...
    async def process_query(
        ...
        """Enhanced query processing with multi-modal support (FIXED)"""
        history = history or []
